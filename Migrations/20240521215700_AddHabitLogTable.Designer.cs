...
namespace HabitifyBackend.Migrations
{
    ...
    [Migration("20240521215700_AddHabitLogTable")]
    partial class AddHabitLogTable
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("HabitifyBackend.Models.Habit", b =>
                {
                    ...
                    b.Property<bool>("IsCompleteDaily")
                        .HasColumnType("bit");

                    b.Property<bool>("IsCompleteWeekly")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("HabitifyBackend.Models.User", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
